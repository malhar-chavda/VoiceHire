...
from utils.helpers.prompts import QUESTION_GENERATION_PROMPT
...
class QuestionService:
    ...
    async def generate(
        ...
        num_questions = max(2, min(10, num_questions))
        ...
        try: 
            result: GeneratedQuestions = await pdf_parser.extract_structured_data(
                raw_text=payload,
