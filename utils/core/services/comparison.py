...
from utils.helpers.prompts import COMPARISON_PROMPT
from models.interview_model import ComparisonSchema
...
class MatchingService:
    ...
    async def evaluate(
        ...
        structured_llm = App.smart_llm.with_structured_output(ComparisonSchema)
